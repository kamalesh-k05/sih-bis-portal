...
const PillNav = ({
  ...
  const logoRef = useRef<HTMLAnchorElement | HTMLLinkElement | null>(null);
      ...
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        {isRouterLink(items?.[0]?.href) ? (
          <Link
            ...
            role="menuitem"
            ref={(el) => {
              (logoRef as React.MutableRefObject<HTMLElement | null>).current = el;
            }}
          >
          ...
          <a
            ...
            onMouseEnter={handleLogoEnter}
            ref={(el) => {
              (logoRef as React.MutableRefObject<HTMLElement | null>).current = el as unknown as HTMLElement;
            }}
          >
            <img src={logo} alt={logoAlt} ref={logoImgRef} />
          </a>
